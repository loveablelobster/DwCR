  ...
  RSpec.describe 'SchemaEntity' do
    ...
    context 'gets the columns' do
      it 'gets the columns' do
        ...
        expect(cc).to include(term: 'http://rs.tdwg.org/dwc/terms/occurrenceID',
                              name: 'occurrence_id', alt_name: 'occurrence_id',
    ...
    it 'returns a list of alt_names as content headers, sorted by index' do
      expect(@media.content_headers).to contain_exactly(:coreid,
                                                        :identifier,
                                                        :access_uri,
                                                        :title,
                                                        :format,
